...
CONFIG_PATH = os.path.join(os.path.dirname(__file__), 'config/walking_go2_FDDP.yml')
...
def main():
    ...
    simulator = Go2Sim(mode='lowlevel', render=True, dt=dt_sim, xml_path=SIM_XML_PATH)
