...
ASSETS_PATH = os.path.join(os.path.dirname(__file__), '../../robots/unitree_go2')
    ...
    def __init__(self, mode='lowlevel', render=True, dt=0.002, xml_path=None):
        ...
        if xml_path is None:
            self.model = mujoco.MjModel.from_xml_path(
                os.path.join(ASSETS_PATH, '/scene_foot_collision.xml')
            )
        else:
        ...
        self.initial_q = np.array([0.0000, 0.9000, -1.8000, 
