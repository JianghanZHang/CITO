...
running_DAM = DifferentialActionModelMJ(mj_model, mj_data, state, nu, njoints, fids, runningCostModel, RunningConstraintModelManager)
waypoint_DAM = DifferentialActionModelMJ(mj_model, mj_data, state, nu, njoints, fids, runningCostModel, WaypointConstraintModelManager)
terminal_DAM = DifferentialActionModelMJ(mj_model, mj_data, state, nu, njoints, fids, terminalCostModel)
