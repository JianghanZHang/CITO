...
x_des = np.array(P_des + 
                 ...
                 W_des + 
                 v0[6:])
xDesActivation = crocoddyl.ActivationModelWeightedQuad(np.array(2 * [0] +  # base x, y position
                                                                1 * [1.0] +  # base z position
                                                                3 * [1e-2] +  # base orientation
...
terminalCostModel.addCost("xDes", xDesCost, 5e4)
